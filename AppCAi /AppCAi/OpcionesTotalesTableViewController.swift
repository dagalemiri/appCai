//
//  OpcionesTotalesTableViewController.swift
//  AppCAi
//
...
class OpcionesTotalesTableViewController: UITableViewController {

    @IBOutlet var labelUsuario: UILabel!
    override func viewDidLoad() {
        super.viewDidLoad()
        self.ComprobarEstadoSwitch()
        self.labelUsuario.text = Estaticos.usuario
    }
